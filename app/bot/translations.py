MESSAGES = dict(
    {
        ...
        "pin_me": {
            ...
            "de": "📌 Pinne diesen Chat, damit du mich nie verlierst",
            "es": "📌 Ancla este chat para nunca perderme",
        ...
        "active_sub_caption": {
            ...
            "ru": "Твоя подписка активна до:\n"
                  ...
                  "                    <b>{date}</b>\n"
                  "=========================\n"
                  "По истечении этого срока основные функции приложения станут недоступными",
...
QUESTIONARY = dict(
    {
        ...
        "fluency": {
            ...
            "de": "Wie fließend sprichst du die Sprache?",
            "es": "¿Cuál es tu nivel de fluidez?",
            "zh": "你的流利程度如何？",
        },
        "fluency_levels": {
            "en": {
        ...
        "choose_topic": {
            "en": "What interests you the most from the options below? Choose 3 topics",
            "ru": "Какое увлечение тебя интересует больше всего из предложенного выбора ниже? Выберите 3 темы",
            "de": "Was interessiert dich am meisten aus den folgenden Optionen? Wählen Sie 3 Themen",
            "es": "¿Qué te interesa más de las opciones siguientes? Elija 3 temas",
            "zh": "以下选项中你最感兴趣的是什么？选择3个主题",
        },
        "topics": {
            "en": {
                "music": "🎵  Music",
            ...
            "ru": {
                ...
                "games": "🎮  Видеоигры",
                "endselection": "🗞️ Подтвердить выбор",
            },
            "de": {
                "music": "🎵  Musik",
                "movies": "🍿  Filme",
                ...
                "travel": "✈️   Reisen",
                "games": "🎮 Videospiele",
                "endselection": "🗞️ Auswahl bestätigen",
            },
            "es": {
                "music": "🎵  Música",
                "movies": "🍿  Películas",
                ...
                "travel": "✈️   Viajes",
                "games": "🎮 Videojuegos",
                "endselection": "🗞️ Confirmar elección",
            },
            "zh": {
                "music": "🎵  音乐",
                "movies": "🍿  电影",
        ...
        "payment_offer": {
            ...
            "ru": "🎯 Бесплатный 3-дневный пробный период со всеми функциями\n"
                ...
                "• Персональный словарь для твоих слов\n"
        ...
        "terms": {
            ...
            "de": "Um unseren Service zu nutzen, musst du der Nutzungsvereinbarung zustimmen",
            "es": "Para usar nuestro servicio, debes aceptar el acuerdo de usuario",
            "zh": "为了使用我们的服务，您必须同意用户协议",
        },
        # TODO: Исправить логику на более читаемый алгоритм
        "where_youcamefrom": {
            "en0": "🗣️ Friends told me",
            "ru0": "🗣️ Знакомые рассказали мне",
            "de0": "🗣️ Freunde haben es mir erzählt",
            "es0": "🗣️ Amigos me lo contaron",
            "zh0": "🗣️ 朋友告诉我的",
            "en1": "🌐 Found it on the Internet",
            "ru1": "🌐 Нашел в Интернете",
            "de1": "🌐 Im Internet gefunden",
            "es1": "🌐 Lo encontré en Internet",
            "zh1": "🌐 在互联网上找到的",
            "en2": "📇 Through an advertisement",
            "ru2": "📇 Через рекламу",
            "de2": "📇 Durch eine Werbung",
            "es2": "📇 A través de un anuncio",
            "zh2": "📇 通过广告",
        },
    }
)
...
WEEKLY_QUIZ = dict({
    ...
    "how_it_works": {
        ...
        "ru": "<b>Теория интервального повторения</b>\n\nВ основе обучения"
              ...
              "Моя система построит для тебя персональный график повторений, чтобы бороться с забыванием. "
              "Вместо того чтобы заучивать все подряд каждый день, я сама напомню повторить "
              "слова именно в тот момент, когда ты вот-вот готов(а) их забыть. Это гарантирует, что каждое "
              "cлово надежно закрепится в долгосрочной памяти с минимальными усилиями с твоей стороны",
        ...
        "no_rights": {
            ...
            "de": "Keine richtigen Antworten",
            "es": "Sin respuestas correctas",
            "zh": "没有正确答案",
        },
        "no_wrongs": {
            "en": "No wrong answers",
            "ru": "Нет ошибочных ответов",
            "de": "Keine falschen Antworten",
            "es": "Sin respuestas incorrectas",
            "zh": "没有错误答案",
        },
        "question_text": {
            "en": (
        ...
        "right_answer": {
            ...
            "de": "<b>✅ Das ist richtig!</b>\n\n" "<b>Wort:</b> <i>{correct_word}</i>",
            "es": "<b>✅ ¡Correcto!</b>\n\n" "<b>Palabra:</b> <i>{correct_word}</i>",
            "zh": "<b>✅ 正确！</b>\n\n" "<b>单词：</b> <i>{correct_word}</i>",
        },
        "wrong_answer": {
            "en": (
            ...
            "de": (
                ...
                "<b>Deine Antwort:</b> <i>{selected_word}</i>\n"
                "<b>Richtige Antwort:</b> <i>{correct_word}</i>\n"
            ),
            "es": (
                "❌ Desafortunadamente, eso es incorrecto\n\n"
                "<b>Tu respuesta:</b> <i>{selected_word}</i>\n"
                "<b>Respuesta correcta:</b> <i>{correct_word}</i>\n"
            ),
            "zh": (
                "❌ 不幸的是，不正确\n\n"
                "<b>你的答案：</b> <i>{selected_word}</i>\n"
                "<b>正确答案：</b> <i>{correct_word}</i>\n"
            ),
        },
        "congradulations": {
            "en": (
            ...
            "de": (
                "🎉 Herzlichen Glückwunsch! Du hast das Quiz für alle gelernten Wörter dieser Woche abgeschlossen.\n\n"
                "Wörter, die du richtig gewählt hast: {rights}\n"
                "Wörter, bei denen du einen Fehler gemacht hast: {wrongs}\n"
            ),
            "es": (
                "🎉 ¡Felicidades! Completaste este cuestionario para todas las palabras aprendidas esta semana.\n\n"
                "Palabras que elegiste correctamente: {rights}\n"
                "Palabras en las que te equivocaste: {wrongs}\n"
            ),
            "zh": (
                "🎉 恭喜！你完成了本周所有学习单词的测验。\n\n"
                "你答对的单词：{rights}\n"
...
NOTIFICATIONS = dict({
    "havent_seen_you": {
        ...
        "ru": [
            ...
            "Ты где? 🥺 Без тебя мой словарь такой пустой... Давай наполним его вместе?",
