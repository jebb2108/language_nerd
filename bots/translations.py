QUESTIONARY = dict(
    {
        "intro": {
            "en": ("Welcome! Here are the next steps for you:\n\n"
            ...
            "ru": ("Добро пожаловать! Вот что тебя ждёт:\n\n"
        ...
        "need_profile": {
            ...
            "ru": "Давайте познакомимся немного больше\n\n"
                  "Нам нужна информация о твоем профиле, чтобы начать общение с другими\n\n"
                  "Сначала, я бы хотел попросить тебя <b>выключить VPN</b> (если он у тебя есть), "
                  "так я смогу обработать твою информацию правильно\n\n"
        ...
        "need_location": {
            ...
            "ru": "Для корректной работы приложения нужна твоя геолокация, пожалуйста, предоставь ее по кнопке ниже.\n\n"
                  ...
                  "Если ты не хочешь, чтобы мы использовали вашу геолокацию, то нажми кнопку 'Отказаться'",
        },
...
FIND_PARTNER = dict({
    ...
    "success": {
        ...
        "ru": "Спасибо за терпение 🤝\nНажми на /menu, чтобы перейти в главное меню",
    },
